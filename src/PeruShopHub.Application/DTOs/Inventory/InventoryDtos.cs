...
public record InventoryItemDto(Guid ProductId, string Sku, string ProductName, int TotalStock, int Reserved, int Available, decimal UnitCost, decimal StockValue);
