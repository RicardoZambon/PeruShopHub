...
public interface IDashboardService
{
    ...
    Task<IReadOnlyList<ProductRankingDto>> GetTopProductsAsync(int limit, string period = "30dias", CancellationToken ct = default);
    Task<IReadOnlyList<ProductRankingDto>> GetLeastProfitableAsync(int limit, string period = "30dias", CancellationToken ct = default);
