...
namespace PeruShopHub.Infrastructure.Migrations
{
    ...
    [Migration("20260329142818_AddUserDataExport")]
    partial class AddUserDataExport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeruShopHub.Core.Entities.MarketplaceClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruShopHub.Core.Entities.MarketplaceMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ExternalPackId");

                    b.HasIndex("TenantId", "IsRead");

                    b.HasIndex("TenantId", "OrderId");

                    b.ToTable("marketplace_messages", (string)null);
                });

            modelBuilder.Entity("PeruShopHub.Core.Entities.MarketplaceQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ExternalItemId");

                    b.HasIndex("TenantId", "Status");

                    b.ToTable("marketplace_questions", (string)null);
                });
            ...
            modelBuilder.Entity("PeruShopHub.Core.Entities.OnboardingProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<string>>("StepsCompleted")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("PeruShopHub.Core.Entities.ResponseTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruShopHub.Core.Entities.ResponseTimeSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MessageThresholdHours")
                        .HasColumnType("integer");

                    b.Property<int>("QuestionThresholdHours")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ResponseTimeSettings");
                });
            ...
            modelBuilder.Entity("PeruShopHub.Core.Entities.UserDataExport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
