...
export interface OrderDetail {
  ...
  fulfilledAt?: string;
  orderDate: string;
  shipping: { trackingNumber?: string; trackingUrl?: string; carrier?: string; logisticType?: string; shippingStatus?: string; shippingCost?: number | null; isFreeShipping?: boolean; isFulfillment?: boolean; timeline?: { status: string; timestamp?: string; description?: string }[] };
